...
export default function StructuredAnswerCard({ data, onSelectTopic }: StructuredAnswerCardProps) {
  ...
  return (
    <div className="space-y-4 text-sm leading-relaxed">
      ...
      {/* Structured Details Container if any fields are present */}
      {(responsibleUnit || location || (requiredDocuments && requiredDocuments.length > 0) || (nextSteps && nextSteps.length > 0)) && (
        <div className="rounded-xl border border-campus-border bg-campus-surface p-4 space-y-4 shadow-subtle my-2">
          
          {/* Responsible Office / Service Header */}
          {responsibleUnit && (
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {location.mapLink && (
                  ...
                  >
                    View on Campus Map / Get Directions <ExternalLink className="w-3 h-3" />
                  </a>
                )}
              </div>
            </div>
          ...
          {requiredDocuments && requiredDocuments.length > 0 && (
            <div className="pt-2 border-t border-campus-border">
              <div className="flex items-center gap-1.5 text-xs font-semibold text-campus-text mb-2">
                ...
                <span>What You Need To Bring (Documents)</span>
              </div>
          ...
          {contact && (contact.phone || contact.email || contact.helpline) && (
      ...
      {sources && sources.length > 0 && (
        <div className="flex flex-wrap items-center gap-2 pt-1 text-[11px] text-campus-muted">
      ...
      {relatedTopics && relatedTopics.length > 0 && onSelectTopic && (
        <div className="pt-2">
          <div className="text-[11px] font-semibold uppercase tracking-wider text-campus-muted mb-1.5 flex items-center gap-1">
            ...
            <span>You may also find useful</span>
          </div>
