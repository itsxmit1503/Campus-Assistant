        ...
        <div className="rounded-xl border border-campus-border bg-campus-surface p-4 space-y-3.5 shadow-subtle my-2">
          ...
          {showLocation && location && (
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 flex items-center justify-center flex-shrink-0 mt-0.5 border border-emerald-200 dark:border-emerald-800">
              ...
              <div className="flex-1 min-w-0 space-y-1">
                <div className="flex items-center justify-between">
                  ...
                  {location.campus && (
                    <span className="inline-flex items-center text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-900/60 text-emerald-800 dark:text-emerald-200 border border-emerald-300 dark:border-emerald-700">
                      📍 {location.campus}
                    </span>
                  )}
                </div>
                
                <div className="font-semibold text-campus-text text-sm">
                  {location.building || location.name} {location.floor ? `(${location.floor})` : ''}
                </div>

                {location.address && (
                  <div className="text-xs text-campus-muted leading-tight">
                    {location.address}
                  </div>
                )}
